        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" name="nama" id="nama" class="form-control {{ $errors->has('nama') ? 'is-invalid':'' }}" placeholder="Masukan Nama Jabatan..." max="35" value="{{ $jabatan->nama }}" required autocomplete="off" autofocus>
          ...
          <div class="col-md-8">
            <div class="form-group">
              ...
              <textarea name="keterangan" id="keterangan" class="form-control {{ $errors->has('keterangan') ? 'is-invalid':'' }}" cols="1" rows="1" maxlength="100" placeholder="Masukan Keterangan Jabatan... *Keterangan Boleh di-Kosongkan">{{ $jabatan->keterangan }}</textarea>
              <span class="invalid-feedback">
