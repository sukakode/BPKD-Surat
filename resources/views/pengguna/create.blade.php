              ...
              <div class="col-md-4">
                <div class="form-group">  
                  ...
                  <div class="input-group">
                    ...
                    <input type="number" name="nip" id="nip" class="form-control borad-r {{ $errors->has('nip') ? 'is-invalid':'' }}" maxlength="18" pattern="/d" value="{{ old('nip') }}" placeholder="Masukan NIP Pengguna..." required autocomplete="off" autofocus>
              ...
              <div class="col-md-8">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="nama" id="nama" class="form-control borad-r {{ $errors->has('nama') ? 'is-invalid':'' }}" max="35" maxlength="35" value="{{ old('nama') }}" placeholder="Masukan Nama Pengguna..." required autocomplete="off">
                    <span class="invalid-feedback">
                      {{ $errors->first('nama') }}
                    </span>
                  </div>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="notelp" id="notelp" class="form-control borad-r {{ $errors->has('notelp') ? 'is-invalid':'' }}" maxlength="14" pattern="\d*" placeholder="Masukan Nomor Telpon..." value="{{ old('notelp') }}" required autocomplete="off">
                    <span class="invalid-feedback">
                      {{ $errors->first('notelp') }}
                    </span>
                  </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" name="email" id="email" class="form-control borad-r {{ $errors->has('email') ? 'is-invalid':'' }}" maxlength="246" placeholder="Masukan E-Mail Pengguna..." value="{{ old('email') }}" required>
                    <span class="invalid-feedback">
                      {{ $errors->first('email') }}
                    </span>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" name="email_confirmation" id="email_confirmation" class="form-control borad-r {{ $errors->has('email') ? 'is-invalid':'' }}" maxlength="246" placeholder="Masukan Ulang E-Mail Pengguna..." required>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" name="password" id="password" class="form-control borad-r {{ $errors->has('password') ? 'is-invalid':'' }}" maxlength="246" placeholder="Masukan Password Pengguna..." required>
                    <span class="invalid-feedback">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-control borad-r {{ $errors->has('password') ? 'is-invalid':'' }}" maxlength="246" placeholder="Masukan Ulang Password Pengguna..." required>
                  </div>
                </div>
              </div>
              <div class="col-12">
