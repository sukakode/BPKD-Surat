  ...
  <div class="card card-outline card-success">
    <div class="card-header d-flex p-0">
      ...
      <ul class="nav nav-pills float-right ml-auto p-2">
        <li class="nav-item"><a class="nav-link btn btn-danger text-white btn-sm mr-3" href="{{ route('disposisi.index') }}"><span class="fa fa-arrow-left"></span> &ensp; Kembali</a></li>
    ...
    <div class="card-body p-0">
      <div class="tab-content">
        <div class="tab-pane p-2 active" id="masuk"> 
          <form action="{{ route('disposisi.store', $disposisi->id) }}" method="post">
            @csrf
            @livewire('disposisi-create')
          </form>
        </div>
        <div class="tab-pane" id="aktif"> 
          @livewire('disposisi-aktif', ['disposisi' => $disposisi->id])
        </div>
